...
export function AnimatedBeamDemo() {
  ...
  return (
    <section className="h-[500px] w-full mt-20">
        <div className=" text-center flex-col flex gap-4">
            <h1 className="text-5xl font-bold">Tudo está conectado</h1>
            <p className="dark:text-gray-300 text-gray-600 md:text-xl mb-5">Suas ferramentas de trabalho não serão um problema, a Solo integra tudo.</p>
        </div>
    <div
      className="relative flex  items-center justify-center overflow-hidden rounded-lg p-10"
      ref={containerRef}
      >
