        ...
        <div className="grid grid-cols-1 gap-6 mt-8 md:grid-cols-3 md:gap-8">
            <div className="">
                <div className="flex space-x-2 ">
                    <span className="dark:text-gray-300 text-gray-600 md:text-xl mb-5">Passo 1</span>
                    <Image 
                        src='/passo1.svg'
                        width={70}
                        height={70}
                ...
                <CardTitle className="text-3xl">Solicite</CardTitle>
                <CardDescription>
                    Nos diga qual é o problema e iremos desenvolver uma solução
                </CardDescription>
                </Card>
            </div>
            <div className="">
                ...
                <CardTitle className="text-3xl">Baixe</CardTitle>
                <CardDescription>
                    No seu dashboard você irá fazer download do seu robô
                </CardDescription>
                </Card>
                <div className="items-center justify-center flex space-x-2 mt-3">
                    <Image 
                        src='/passo2.svg'
                        width={70}
                        height={70}
                        alt='passo2'
                    />
                    <span className="dark:text-gray-300 text-gray-600 md:text-xl mt-3">Passo 2</span>
                </div>
            </div>
            <div className="">
                <div className="justify-end flex space-x-2 ">
                    <Image 
                        ...
                        alt='passo3'
                    />
                    <span className="dark:text-gray-300 text-gray-600 md:text-xl mb-5">Passo 3</span>
                </div>
                <Card>
                <CardSkeletonContainer>
                    <Skeleton />
                </CardSkeletonContainer>
                <CardTitle className="text-3xl">Execute</CardTitle>
                <CardDescription>
                    Com nosso software, execute o robô e deixe que ele faça o resto
                </CardDescription>
                </Card>
            </div>
        </div>
